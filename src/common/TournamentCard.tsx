...
function TournamentCard() {
    ...
    return (
        <article id="tournament-card"
            className="w-full h-full relative shadow-lg border border-BlushPink/20 shadow-BlushPink/60 transition-transform duration-1000 transform-3d rounded-2xl overflow-hidden"
            style={{
                "transform": showPoster ? "rotateY(180deg)" : "rotateY(0deg)"
            }}
        >
            <section className="w-full h-full backface-hidden n bg-white" >
                    ...
                    <div className="px-4 py-2">
                        <dl>
                            <div>
                                ...
                                <div className="grid grid-cols-1 gap-2 py-4 sm:grid-cols-12 sm:gap-6">
                                    ...
                                    <dd className="sm:col-span-9 text-gray-900">
                                        ...
                                        <p className="mt-1 text-sm text-gray-500 mt-px">일정을 캘린더에 추가하세요.</p>
                                    </dd>
                                </div>
                            ...
                            <div className="flex justify-center">
                                <button className="p-4 border " onClick={() => setShowDetail(!showDetail)}>펼쳐 보기</button>
                            </div>
                            <div style={{"maxHeight" : showDetail ? "1000px" : "0px"}} className="max-h-0 transition-[max-height] duration-500 overflow-hidden">
                                <div className="grid grid-cols-1 gap-2 py-4 sm:grid-cols-12 sm:gap-6">
                                    <dt className="sm:col-span-3 flex items-start gap-2 text-sm font-medium text-gray-500 mt-px">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="mt-0.5 h-4 w-4 flex-none" viewBox="0 0 24 24" fill="currentColor">
            ...
            <section className="w-full h-full absolute top-0 left-0 rotate-y-180 -z-1 " onClick={() => setShowPoster(false)}>
